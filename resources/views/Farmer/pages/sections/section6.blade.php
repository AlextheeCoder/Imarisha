    ...
    <div class="part">
        ...
        <div class="radio-group">
            <div class="custom-radio">
                <input type="radio" id="interest-new-crops-yes" name="interest-new-crops" value="yes">
            ...
            <div class="custom-radio">
                <input type="radio" id="interest-new-crops-no" name="interest-new-crops" value="no">
...
<div class="part">
        ...
        <div class="radio-group">
            <div class="custom-radio">
                <input type="radio" id="interest-livestock-yes" name="interest-livestock-farming" value="start-livestock-farming">
                <label class="radio-label" for="interest-livestock-yes">
                    <div class="radio-circle"></div>
                    <span class="radio-text">Start livestock farming</span>
                </label>
    
                <input type="radio" id="interest-livestock-expand" name="interest-livestock-farming" value="expand-livestock-farming">
                <label class="radio-label" for="interest-livestock-expand">
                    <div class="radio-circle"></div>
                    <span class="radio-text">Expand livestock farming</span>
                </label>
    
                <input type="radio" id="interest-livestock-no" name="interest-livestock-farming" value="not-interested">
